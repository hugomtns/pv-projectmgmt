 ...
 */
export function createDocumentLink(documentId: string): NotificationLink {
  return {
    type: 'document',
    documentId,
  };
 ...
 */
export function createDesignLink(designId: string, projectId?: string): NotificationLink {
  return {
    type: 'design',
    designId,
    projectId,
